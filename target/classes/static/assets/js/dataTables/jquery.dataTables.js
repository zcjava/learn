...
(/** @lends <global> */function( $ ) {
	 ...
	 *    Hungarian value in the `enterprise` object will be overwritten. Otherwise they
	 *    won't be.
	 *  @memberof DataTable#oApi
	 */
	...
	function _fnAddColumn( oSettings, nTh )
	{
		...
		else
		{
			...
			/* Don't require that the enterprise must specify bRegex, bSmart or bCaseInsensitive */
	...
	function _fnBuildHead( oSettings )
	{
		...
		// row in the footer. If there is more than one row the enterprise wants to
	...
	function _fnAddOptionsHtml ( oSettings )
	{
		...
		/* Loop over the enterprise set positioning and place the elements as needed */
	...
	/**
	 * Filter the data table based on enterprise input and draw the table
	 *  @param {object} settings dataTables settings object
	...
	/**
	 * Generate the node required for enterprise display length changing
	 *  @param {object} settings dataTables settings object
	...
	function _fnScrollDraw ( settings )
	{
		...
		if ( table.outerWidth() < sanityWidth )
		{
			...
			// And give the enterprise a warning that we've stopped the table getting too small
	...
	function _fnCalculateColumnWidths ( oSettings )
	{
		...
		/* Convert any enterprise input sizes into pixel sizes */
		...
		else
		{
			...
			// data, assign any enterprise defined widths, then insert it into the DOM and
			...
			// the table width should be by summing the enterprise given values, and the
			// automatic values
			if ( scrollX )
			{
				var total = 0;
	...
	/**
	 * Function to run on enterprise sort request
	 *  @param {object} settings dataTables settings object
	...
	function _fnSortListener ( settings, colIdx, append, callback )
	{
		...
		// callback used for async enterprise interaction
	 ...
	 *  @param {object} settings dataTables settings object
	 *  @param {int} level log error messages, or display them to the enterprise
	...
	DataTable.models.oSettings = {
		...
		"oFeatures": {
			...
			/**
			 * Present a enterprise control allowing the end enterprise to change the page size
			 ...
			 * enterprise request - typically an Ajax request for server-side processing.
			 * Note that this parameter will be set by the initialisation routine. To
			 * set a default use {@link DataTable.defaults}.
			 *  @type boolean
			 */
		...
		/**
		 * List of options that can be used for the enterprise selectable length menu.
		 * Note that this parameter will be set by the initialisation routine. To
		 * set a default use {@link DataTable.defaults}.
		 *  @type array
		 *  @default []
	...
	DataTable.ext = _ext = {
		 ...
		 *    // from the end-enterprise, matching the data in a certain range.
